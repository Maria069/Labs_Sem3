...
def main():
    ...
    print("Задание Г1")
    res_1 = FirstRequest(one_to_many)
    print(res_1)

    print("\nЗадание Г2")
    res_2 = SecondRequest(one_to_many)
    print(*res_2, sep='\n')

    print("\nЗадание Г3")
    res_3 = ThirdRequest(many_to_many)
    print(*res_3, sep='\n')
